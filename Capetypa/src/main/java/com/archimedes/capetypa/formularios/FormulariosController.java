...
public class FormulariosController {
	...
	@GetMapping
	public List<Formularios> getAll() {
	...
	public String getOne(@PathVariable Long id) throws JsonProcessingException {
		...
		if (formulariosRepository.existsById(id)) {
			...
			Formularios formularios = formulariosRepository.findById(id).get();
		...
		@PostMapping
		public Formularios post(@RequestBody Formularios formularios) {
