...
function getAuthor(artData) {
    $.get(app.apiBaseURL + 'usuarios/' + artData.author)
        .done((userData) => {
                ...
                cmtData.forEach((cmt) => {
                    ...
                    commentList += `
                        <div class="cmtBox">
                            ...
                            <div class="cmtContent">${comment}</div>
                        </div>
                    `
                })
            } else {
    ...
    $.get(app.apiBaseURL + 'comentarios')
        .done((data) => {
            if (data.length > 0) {
                ...
                $.post(app.apiBaseURL + 'comentarios', formData)
                    .done((data) => {
                        if (data.id > 0) {
...
//     $.ajax({
//         type: 'PATCH',
//         url: app.apiBaseURL + 'artigos/' + artData.id,
